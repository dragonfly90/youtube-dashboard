import{o as h,l as m,b as o}from"./index-B5T2II_u.js";import{a as b,C as f}from"./classifier-tAIPdZbh.js";let i="count",d=-1;function p(t){return o().clusterMeta?.[t]||f[t]||{id:t,label:t,emoji:"",color:"#94a3b8"}}function v(){const t=o().clusterMeta;return t?Object.values(t).filter(e=>e.id!=="other"):b}function M(t){t.innerHTML=`
